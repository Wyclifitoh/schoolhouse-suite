...
Deno.serve(async (req) => {
  ...
  try {
    ...
    if (!students?.length) {
      const studs = [
        { school_id: sid, admission_number: "CHUO/2025/001", first_name: "Brian", last_name: "Akinyi", full_name: "Brian Akinyi", current_grade_id: g1.id, current_stream_id: s1e?.id, current_term_id: currentTerm.id, status: "active", date_of_birth: "2018-03-15", gender: "male", parent_name: "Mary Akinyi", parent_phone: "+254711111111", admission_date: "2025-01-06" },
        { school_id: sid, admission_number: "CHUO/2025/002", first_name: "Cynthia", last_name: "Kamau", full_name: "Cynthia Kamau", current_grade_id: g1.id, current_stream_id: s1e?.id, current_term_id: currentTerm.id, status: "active", date_of_birth: "2018-06-22", gender: "female", parent_name: "John Kamau", parent_phone: "+254722222222", admission_date: "2025-01-06" },
        { school_id: sid, admission_number: "CHUO/2025/003", first_name: "Dennis", last_name: "Chebet", full_name: "Dennis Chebet", current_grade_id: g4.id, current_stream_id: s4e?.id, current_term_id: currentTerm.id, status: "active", date_of_birth: "2015-01-10", gender: "male", parent_name: "Susan Chebet", parent_phone: "+254733333333", admission_date: "2023-01-09" },
        { school_id: sid, admission_number: "CHUO/2025/004", first_name: "Faith", last_name: "Omondi", full_name: "Faith Omondi", current_grade_id: g4.id, current_stream_id: s4e?.id, current_term_id: currentTerm.id, status: "active", date_of_birth: "2015-09-05", gender: "female", parent_name: "David Omondi", parent_phone: "+254744444444", admission_date: "2023-01-09" },
        { school_id: sid, admission_number: "CHUO/2025/005", first_name: "George", last_name: "Muthoni", full_name: "George Muthoni", current_grade_id: g7.id, current_stream_id: s7e?.id, current_term_id: currentTerm.id, status: "active", date_of_birth: "2012-11-20", gender: "male", parent_name: "Esther Muthoni", parent_phone: "+254755555555", admission_date: "2021-01-04" },
        { school_id: sid, admission_number: "CHUO/2025/006", first_name: "Hannah", last_name: "Wafula", full_name: "Hannah Wafula", current_grade_id: g7.id, current_stream_id: s7e?.id, current_term_id: currentTerm.id, status: "active", date_of_birth: "2012-04-14", gender: "female", parent_name: "Mary Akinyi", parent_phone: "+254711111111", admission_date: "2021-01-04" },
        { school_id: sid, admission_number: "CHUO/2025/007", first_name: "Ian", last_name: "Njoroge", full_name: "Ian Njoroge", current_grade_id: g1.id, current_stream_id: s1e?.id, current_term_id: currentTerm.id, status: "active", date_of_birth: "2018-08-30", gender: "male", parent_name: "John Kamau", parent_phone: "+254722222222", admission_date: "2025-01-06" },
        { school_id: sid, admission_number: "CHUO/2025/008", first_name: "Joy", last_name: "Otieno", full_name: "Joy Otieno", current_grade_id: g4.id, current_stream_id: s4e?.id, current_term_id: currentTerm.id, status: "active", date_of_birth: "2015-12-01", gender: "female", parent_name: "Susan Chebet", parent_phone: "+254733333333", admission_date: "2023-01-09" },
        { school_id: sid, admission_number: "CHUO/2025/009", first_name: "Kevin", last_name: "Kiplagat", full_name: "Kevin Kiplagat", current_grade_id: g7.id, current_stream_id: s7e?.id, current_term_id: currentTerm.id, status: "active", date_of_birth: "2012-07-18", gender: "male", parent_name: "David Omondi", parent_phone: "+254744444444", admission_date: "2021-01-04" },
        { school_id: sid, admission_number: "CHUO/2025/010", first_name: "Lucy", last_name: "Wambui", full_name: "Lucy Wambui", current_grade_id: g1.id, current_stream_id: s1e?.id, current_term_id: currentTerm.id, status: "active", date_of_birth: "2018-02-28", gender: "female", parent_name: "Esther Muthoni", parent_phone: "+254755555555", admission_date: "2025-01-06" },
      ];
