...
const blank: Partial<PlatformPlan> = {
  code: "",
  name: "",
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Manage CHUO subscription plans. Changes only affect new invoices.
          </p>
        </div>
              ...
              <CardContent className="p-5 space-y-2">
                ...
                <div className="text-2xl font-black">
                  {p.billing_mode === "per_student"
                    ? `KSh ${Number(p.price_per_student).toLocaleString()}`
                    : `KSh ${Number(p.base_price).toLocaleString()}`}
                ...
                <div className="text-xs text-muted-foreground">
                  {p.billing_mode} · {p.cycle}
                  {p.min_students || p.max_students
                    ? ` · ${p.min_students || 1}–${p.max_students || "∞"} learners`
                    : ""}
                </div>
            ...
            <div className="grid grid-cols-2 gap-2">
              <div>
                ...
                >
                  ...
                  <SelectContent>
                    {["per_student", "flat", "module", "free"].map((m) => (
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setForm({
                      ...form,
                      price_per_student: Number(e.target.value),
                    })
                  }
                />
              </div>
              <div>
                <Label>Base price (flat / module)</Label>
                <Input
                  type="number"
