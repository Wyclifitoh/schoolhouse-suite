...
const AssignClassTeacher = () => {
  ...
  const handleAssign = () => {
    if (!assignData.class || !assignData.teacher) {
      toast.error("Select class and teacher");
      return;
    }
    toast.success(
      `${assignData.teacher} assigned as class teacher for ${assignData.class} ${assignData.section}`,
    );
    setShowAssign(false);
  };
  ...
  return (
    <DashboardLayout
      ...
      subtitle="Manage class teacher assignments"
    >
          ...
          <Card className="bg-success/5 border-success/10">
            <CardContent className="p-4 text-center">
              <p className="text-2xl font-bold text-success">
                {
                  classTeacherAssignments.filter((c) => c.status === "assigned")
                    .length
                }
              </p>
          ...
          <Card className="bg-destructive/5 border-destructive/10">
            <CardContent className="p-4 text-center">
              <p className="text-2xl font-bold text-destructive">
                {
                  classTeacherAssignments.filter(
                ...
                {classTeacherAssignments.map((a) => (
                  <TableRow key={a.id}>
                    ...
                    <TableCell>
                      <Badge
                        variant={
                          a.status === "assigned" ? "default" : "destructive"
                        }
                        className="text-[10px]"
                      >
                        {a.status}
