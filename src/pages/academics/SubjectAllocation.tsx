...
const SubjectAllocation = () => {
  ...
  // Sync local state from server whenever the class or its allocations genuinely change.
  useEffect(() => {
    const dataStr = JSON.stringify({ allocations, groups, gradeId });
    if (dataStr === lastSyncedStr) return;
    setLastSyncedStr(dataStr);
  ...
  }, [allocations, groups, gradeId, lastSyncedStr]);
