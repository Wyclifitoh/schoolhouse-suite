...
const AttendanceReports = () => {
  ...
  const classes = Array.isArray(classesData)
    ? classesData
    : (classesData as any)?.rows || [];
  const { data: report, isLoading } = useAttendanceReportData({
  ...
  return (
    <DashboardLayout
      ...
      subtitle="Student and staff attendance reports"
    >
            ...
            <CardContent>
              ...
              {isLoading ? (
                ...
                <Table>
                  ...
                  <TableBody>
                    {studentAttendance.map((a: any, i: number) => (
                      <TableRow key={i}>
          ...
          <Card>
            ...
            <CardContent className="p-0">
              {isLoading ? (
                ...
                <EmptyState message="No attendance type data available" />
              ) : (
                <Table>
                  <TableHeader>
                    <TableRow className="bg-muted/50">
                  ...
                  <TableBody>
                    {typeSummary.map((a: any, i: number) => (
                      <TableRow key={i}>
                        <TableCell className="font-medium">
                          {a.student_name}
                        </TableCell>
          ...
          <Card>
            ...
            <CardContent className="p-0">
              {isLoading ? (
                ...
                <EmptyState message="No daily attendance summary available" />
              ) : (
                <Table>
                  <TableHeader>
                    <TableRow className="bg-muted/50">
          ...
          <Card>
            ...
            <CardContent className="p-0">
              {isLoading ? (
                ...
                <EmptyState message="No staff attendance data found" />
              ) : (
                <Table>
                  <TableHeader>
                    <TableRow className="bg-muted/50">
                  ...
                  <TableBody>
                    {staffAttendance.map((s: any, i: number) => (
                      <TableRow key={i}>
                        <TableCell className="font-medium">
                          {s.name || s.staff_name}
                        </TableCell>
