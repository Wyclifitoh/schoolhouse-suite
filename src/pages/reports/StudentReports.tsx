...
const StudentReports = () => {
  ...
  const students =
    streamFilter !== "all"
      ? rawStudents.filter(
          (s: any) =>
            s.stream_id === streamFilter || s.stream_name === streamFilter,
        )
      : rawStudents;
  ...
  return (
    <DashboardLayout
      ...
      subtitle="Comprehensive student information reports"
    >
              ...
              {isLoading ? (
                ...
                <Table>
                  <TableHeader>
                    <TableRow className="bg-muted/50">
                      <TableHead className="font-semibold">Class</TableHead>
                      <TableHead className="font-semibold">Streams</TableHead>
                  ...
                  <TableBody>
                    {classes.map((c: any) => (
                      <TableRow key={c.id}>
                        ...
                        <TableCell>
                          {c.stream_count || c.streams?.length || 0}
                        </TableCell>
          ...
          <Card>
            ...
            <CardContent className="p-0">
              {isLoading ? (
                ...
                <EmptyState message="No guardian data available" />
              ) : (
                <Table>
                  <TableHeader>
                    <TableRow className="bg-muted/50">
          ...
          <Card>
            ...
            <CardContent className="p-0">
              {isLoading ? (
                ...
                <EmptyState message="No student history events found" />
              ) : (
                <Table>
                  <TableHeader>
                    <TableRow className="bg-muted/50">
          ...
          <Card>
            ...
            <CardContent className="p-0">
              {isLoading ? (
                ...
                <EmptyState message="No admission data found" />
              ) : (
                <Table>
                  <TableHeader>
                    <TableRow className="bg-muted/50">
              ...
              <div className="grid gap-4 sm:grid-cols-3">
                <div className="p-6 rounded-xl bg-primary/10 text-center">
                  ...
                  <p className="text-xs text-muted-foreground mt-1">
                    {summary.total
                      ? ((summary.male / summary.total) * 100).toFixed(1)
                      : 0}
                    %
                  </p>
                </div>
                <div className="p-6 rounded-xl bg-info/10 text-center">
                  ...
                  <p className="text-xs text-muted-foreground mt-1">
                    {summary.total
                      ? ((summary.female / summary.total) * 100).toFixed(1)
                      : 0}
                    %
                  </p>
                </div>
