            ...
            <CardContent className="p-6 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              <div>
                <div className="text-lg font-semibold">
                  {statement.student.full_name}
                </div>
                <div className="text-sm text-muted-foreground">
                  Adm. {statement.student.admission_number} ·{" "}
                  {statement.student.grade || "—"}{" "}
                  {statement.student.stream || ""}
                </div>
                <div className="text-xs text-muted-foreground mt-1">
                  {statement.term?.name || "All Terms"}
                  {statement.academic_year?.name
                    ? ` · ${statement.academic_year.name}`
                    : ""}
                </div>
              </div>
              <div className="text-right">
                ...
                <div
                  className={`text-2xl font-bold ${totals!.net_owing > 0 ? "text-destructive" : "text-emerald-600"}`}
                >
