      ...
      <div className="flex items-start justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Track school property, run depreciation and record disposals.
            Postings flow to the General Ledger when categories are linked to
            Chart-of-Accounts.
          </p>
        </div>
        ...
        <div className="grid gap-4 md:grid-cols-4">
          ...
          <Card>
            <CardHeader className="pb-2">
              ...
              <CardTitle className="text-xl">
                {fmt(summary.totals.total_cost)}
              </CardTitle>
            </CardHeader>
          </Card>
          <Card>
            <CardHeader className="pb-2">
              <CardDescription>Accum. Depreciation</CardDescription>
              <CardTitle className="text-xl">
                {fmt(summary.totals.total_accumulated)}
              </CardTitle>
            </CardHeader>
          </Card>
          <Card>
            <CardHeader className="pb-2">
              <CardDescription>Book Value</CardDescription>
              <CardTitle className="text-xl">
                {fmt(summary.totals.total_book_value)}
              </CardTitle>
            </CardHeader>
          </Card>
        </div>
        ...
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(e) => set("purchase_ref", e.target.value)}
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(v) =>
                    setForm({ ...form, depreciation_method: v as DepMethod })
                  }
                >
                  <SelectTrigger>
                    <SelectValue />
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setForm({
                      ...form,
                      depreciation_rate: Number(e.target.value),
                    })
                  }
                  placeholder="e.g. 20"
                />
            ...
            <div className="rounded-md border bg-muted/40 p-3 text-xs text-muted-foreground">
              <div className="flex items-center gap-1 mb-1 font-medium text-foreground">
                <Landmark className="h-3.5 w-3.5" /> Chart of Accounts
                (optional)
              </div>
              Link this category to COA accounts to enable automatic ledger
              posting on depreciation and disposal. Configure account IDs later
              via the Chart of Accounts module.
            </div>
            <div className="flex gap-2">
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        ...
        <DialogFooter>
          ...
          <Button
            onClick={submit}
            disabled={!start || !end || depreciate.isPending}
          >
            Post
          </Button>
        </DialogFooter>
      ...
      <DialogContent>
        ...
        <DialogFooter>
          ...
          <Button
            ...
            disabled={!loc || addMovement.isPending}
          >
            Save
          </Button>
        </DialogFooter>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-4">
        ...
        <Card>
          <CardHeader className="pb-2">
            <CardDescription>Accum. Dep</CardDescription>
            <CardTitle className="text-xl">
              {fmt(data.accumulated_depreciation)}
            </CardTitle>
          </CardHeader>
        </Card>
        <Card>
        ...
        <Card>
          <CardHeader className="pb-2">
            <CardDescription>Acquired</CardDescription>
                ...
                <dl className="grid gap-3 md:grid-cols-2 text-sm">
                  <div>
                    ...
                    <dd className="font-medium">
                      {data.disposal.disposal_date}
                    </dd>
                  </div>
                  <div>
                    <dt className="text-muted-foreground">Method</dt>
                    <dd className="font-medium capitalize">
                      {data.disposal.method.replace("_", " ")}
                    </dd>
                  </div>
                  <div>
                    <dt className="text-muted-foreground">Proceeds</dt>
                    <dd className="font-medium">
                      {fmt(data.disposal.proceeds)}
                    </dd>
                  </div>
                  <div>
                    <dt className="text-muted-foreground">Gain / Loss</dt>
                    <dd
                      className={`font-medium ${data.disposal.gain_loss >= 0 ? "text-green-600" : "text-red-600"}`}
                    >
                  ...
                  <div>
                    ...
                    <dd className="font-medium">
                      {data.disposal.bank_account_name || "—"}
                    </dd>
                  </div>
                  <div>
                  ...
                  <div className="md:col-span-2">
                    ...
                    <dd className="font-mono text-xs">
                      {data.disposal.posting_ref ||
                        "(not posted — configure category COA)"}
                    </dd>
                  </div>
                </dl>
              )}
