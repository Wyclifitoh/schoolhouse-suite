...
export default function AssessmentTasks() {
  ...
  const filters = useMemo(
    () => ({
      ...
      term_id: selectedTerm?.id || undefined,
      year_id: selectedAcademicYear?.id || undefined,
      page,
      limit,
    }),
    [status, search, gradeId, streamId, typeId, selectedTerm?.id, selectedAcademicYear?.id, page],
  );
