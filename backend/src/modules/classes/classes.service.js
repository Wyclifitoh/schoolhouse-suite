...
const listClasses = async (schoolId, pagination) => repo.findAllClasses(schoolId, pagination);
...
const updateStream = async (id, schoolId, data) => repo.updateStream(id, schoolId, data);
...
module.exports = {
  ...
  listGrades, listStreams, createGrade, createStream, updateStream,
