...
const updateUserRole = async (schoolId, userId, role) =>
  repo.updateUserRole(schoolId, userId, role);
const getNotificationTemplates = async (schoolId) =>
  repo.findNotificationTemplates(schoolId);
const updateNotificationTemplate = async (id, data) =>
  repo.updateNotificationTemplate(id, data);
